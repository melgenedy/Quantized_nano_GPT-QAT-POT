...
lr_decay_iters = 40000 #600000 # should be ~= max_iters per Chinchilla
...
exec(open(file='config/finetune_shakespeare.py').read()) #exec(open('configurator.py').read()) # overrides from command line or config file
